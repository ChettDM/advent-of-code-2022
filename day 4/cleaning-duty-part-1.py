...
for assignments in lines:
    ...
    if (int(firstElfsAssignment[0]) >= int(secondElfsAssignment[0])
            and int(firstElfsAssignment[1]) <= int(secondElfsAssignment[1])):
        total += 1
        continue

    if (int(secondElfsAssignment[0]) >= int(firstElfsAssignment[0])
            and int(secondElfsAssignment[1]) <= int(firstElfsAssignment[1])):
        total += 1
        continue
